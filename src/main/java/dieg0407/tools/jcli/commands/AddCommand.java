...
public class AddCommand implements Callable<Integer> {
  ...
  @CommandLine.Option(names = {"-t",
      "--type"}, description = "The type of the dependency. Valid values are: ${COMPLETION-CANDIDATES}.", defaultValue = "compile")
  DependencyType type;

  @CommandLine.Option(names = {"-a",
      "--artifactId"}, description = "The artifactId of the dependency.", required = true)
  String artifactId;
  ...
  @CommandLine.Option(names = {"-A",
      "--auto-accept"}, description = "Automatically accept the first option that matches the provided values if more than one is found.")
  boolean autoAccept;
